...
/*   Updated: 2025/07/15 11:34:15 by camurill         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << this->_name << " received damange: you less -" << amount << " hits points" << std::endl;
}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	{
		std::cout << this->_name << "be repeaired, now you have: " << this->_hit_points + amount << std::endl;
		this->_hit_points += amount;
		this->_energy_points--;
	}
	else if (this->_energy_points == 0)
		std::cout << "Cannot repaired, you don't have energy points" << std::endl;
	else if (this->_hit_points == 0)
		std::cout << "Cannot repaired, you don't have any points hits" << std::endl;
	else
		std::cout << "Cannot repaired, you don't have more than 10 hits points" << std::endl;
}
